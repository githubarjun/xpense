	...
	<script>
		$(document).ready(function() {
			...
			$("#submitbutton").click(function(){
				...
				if(status == true){
					$.post($("#spendingReport").attr("action"),$("#spendingReport").serialize(),function(data){
						$("#content").html(data);
					}).fail(function(xhr, ajaxOptions, thrownError){
						window.location.href = logoutLink;
					});					
...
%>	
	...
	<html:form styleId="spendingReport" action="/spendingReport">
		
		<h3 class="formheader">Spending Report >>> </h3>
		...
		<tr>
			<td>
				...
				<tr>
					...
					<td> : </td>
					<td>
						<html:select name="SpendingReportForm" property="group" title="Group Name">
							<html:option value="0">Select</html:option>
							<html:optionsCollection name="SpendingReportForm" property="groupDTOs" label="groupName" value="id"/>
						</html:select>	
					</td>
					<td>&nbsp;</td>
					<td>
		...
		<logic:notEmpty name="SpendingReportForm" property="reportData.headers">
			<table class="bordered" width="100%">
				<tr>
					<th>Date</th>
					<th>Desc</th>
					<th>Amount</th>
				<logic:iterate name="SpendingReportForm" property="reportData.headers" id="hd">
					...
					<logic:iterate name="SpendingReportForm" property="reportData.dataDtls" id="datalist">
					<tr>
			...
			<h4 class="formheader" align="center">Spending Summary </h4>
			<table class="bordered" align="center">
				<logic:iterate name="SpendingReportForm" property="reportData.summary" id="entry">
